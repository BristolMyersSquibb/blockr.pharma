...
pp_block_guidance <- function() {
  paste(
      ...
      "drilldown chart claiming USUBJID into a `drill_filter_block`) or a",
      "full cohort dm, in which case `subject` names the USUBJID to display",
      "and the block filters the dm down to that patient.",
